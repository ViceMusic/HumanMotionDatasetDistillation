...
from dd_h36m_npz import DDH36MNPZDataset, DDH36MNPZEval
...
dataset = DDH36MNPZDataset(config, 'train', config.data_aug)
...
eval_dataset = DDH36MNPZEval(eval_config, 'test')
