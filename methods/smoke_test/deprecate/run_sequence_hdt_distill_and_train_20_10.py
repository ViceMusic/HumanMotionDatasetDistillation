...
# ============================================================
# Sequence-level parallel HDT-style motion distillation + train (20->10)
# Save as:
#   methods/smoke_test/run_sequence_hdt_distill_and_train_20_10.py
#
# Run:
#   python methods/smoke_test/run_sequence_hdt_distill_and_train_20_10.py
#
# Core rule:
...
def configure_motion_lengths(config):
    """Force this experiment to use 20 input frames and 10 prediction frames."""
...
class DistillConfig:
    ...
    save_name: str = "h36m_expmap_sequences_distilled_sequence_hdt_20_10_len30_g01_bs16_iter8000.npz"
...
class TrainConfig:
    ...
    log_path: str = "logs/train_sequence_hdt_20_10_len30_g01_bs16_iter8000.txt"
...
def train_distillation():
    ...
    simlpe_config = configure_motion_lengths(build_simlpe_config())
    ...
    print("20->10 mode: synthetic_len=30, input_len=20, output_len=10")
    ...
    save_sequence_bank_npz(
        ...
        cfg.outer_steps,
        logs,
        heldout_entries=[],  # do not store S5 in the distilled training npz
        feature_dim=cfg.feature_dim,
    )
