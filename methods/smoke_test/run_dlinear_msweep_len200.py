...
# Variant: DL-MSweep-Len200; synthetic_len=200; random_50pieces removed; TrainConfig.num_workers=1; SweepConfig.max_workers=45.
...
#      - random_complete: one contiguous 200-frame crop
#      - random_20pieces: 20 random pieces concatenated into 200 frames
...
class DistillConfig:
    ...
    output_dir: str = "datasets/dlinear_msweep_len200"
...
@dataclass
class SweepConfig:
    name: str = "DL-MSweep-Len200"
    seeds = (888, 999, 1234, 2026, 3407)
    output_dir: str = "datasets/dlinear_msweep_len200"
    log_root: str = "logs/dlinear_msweep_len200"
    summary_log: str = "logs/dlinear_msweep_len200/summary_mean_std.txt"
    max_workers: int = 45
...
EXPERIMENTS = [
    ...
    },
    {
        ...
        "lambda_pred": None,
        "lambda_vel": None,
        "desc": "Random baseline. One random contiguous 200-frame crop per training sequence; no distillation.",
    },
    {
        ...
        "lambda_pred": None,
        "lambda_vel": None,
        "desc": "Random baseline. 20 random pieces concatenated into 200 frames per training sequence; no distillation.",
    },
]
...
def write_sweep_summary(summary_path, results):
    ...
    with open(summary_path, "w") as f:
        f.write("DL-MSweep-Len200 summary for Human3.6M / DLinear.\n")
