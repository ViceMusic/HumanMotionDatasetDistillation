...
# logic above, but runs multiple seeds in parallel and adds:
#   - full
...
class SweepConfig:
    ...
    output_dir: str = "datasets/dlinear_msweep_plus"
    log_root: str = "logs/dlinear_msweep_plus"
    summary_log: str = "logs/dlinear_msweep_plus/summary_mean_std.txt"
    max_workers: int = 35
...
EXPERIMENTS = [
    ...
    {
        "base_name": "random_50pieces",
        "mode": "baseline",
        "num_pieces": 50,
        "lambda_pred": None,
        "lambda_vel": None,
        "desc": "Random baseline. 50 random pieces concatenated into 100 frames per training sequence; no distillation.",
    },
]
...
def write_sweep_summary(summary_path, results):
    ...
    with open(summary_path, "w") as f:
        f.write("DL-MSweep+ summary for Human3.6M / DLinear.\n")
        f.write("This run keeps the original DLinear protocols and runs multiple seeds in parallel.\n")
